...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} w-100vw justify-center flex h-100vh  bg-zinc-50 text-gray-950 relative dark:bg-gray-900 dark:text-zinc-50 dark:text-opacity-90`}
      >
