  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] h-[28rem] flex flex-col sm:h-full sm:group-even:ml-[18rem] w-100%">
        ...
        <Image
          ...
          quality={95}
          className="absolute bottom-0 right-0  w-[20rem] sm:top-8 sm:-right-40 sm:w-[28.25rem] rounded-t-lg shadow-2xl
        transition 
